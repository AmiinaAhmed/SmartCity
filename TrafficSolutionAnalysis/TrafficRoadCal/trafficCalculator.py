...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Search for the best possible route between roads based on their traffic level')
    ...
    group.add_argument('-b', '--bench', action='store_true',
                       help='benchmark the software using the provided data-set which is located in the "dataset" folder')
    group.add_argument('-f', '--files', nargs='*',
                       help='provide your own files for analysis (separate each one with commas) [ a.txt, b.txt ... ]')
